...
export {
  queryFamilyMartTracking,
  normalizeStatus,
} from "./familyMartAdapter.ts";
export type {
  FamilyMartTrackingResult,
  FamilyMartQueryInput,
  FamilyMartDeps,
} from "./familyMartAdapter.ts";
export {
...
export {
  queryPostOfficeTracking,
  normalizePostOfficeStatus,
} from "./postOfficeAdapter.ts";
export type {
  PostOfficeTrackingResult,
  PostOfficeQueryInput,
  PostOfficeDeps,
} from "./postOfficeAdapter.ts";
