...
export default function ReceiptPreview() {
  const [status, setStatus] = useState<"loading" | "rendering" | "expired" | "error">("loading");
  ...
  if (status === "loading" || status === "rendering") {
    return (
      <div style={{
        ...
        minHeight: "100dvh", fontFamily: "system-ui,-apple-system,sans-serif", background: "white",
      }}>
  ...
  return (
    <div style={{
      ...
      minHeight: "100dvh", padding: "20px", fontFamily: "system-ui,-apple-system,sans-serif",
      background: "white", boxSizing: "border-box",
    }}>
      <div style={{
        maxWidth: "400px", width: "100%", textAlign: "center",
        padding: "24px", border: "1px solid #e5e7eb", borderRadius: "12px",
      }}>
