...
*文件版本：Step 7C-1 Audit v1.0*
*盤點時間：2026-06-07*
*依據規格：docs/order-step7c-shipment-tracking-model-spec.md（Step 7C Spec v1.1）*
...
export const shippingStatusEnum = [
  "not_shipped", "preparing", "shipped", "arrived",
...
*本文件為施工前盤點，不修改任何 schema 或 migration 檔案。*
*實際施工請參考本文件第 7 節步驟與第 9 節 Checklist。*
