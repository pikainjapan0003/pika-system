...
Step 7F-FAMILYMART-WORKER-INTEGRATION：worker 取 active shipment*trackings，呼叫本 adapter，
更新 tracking_status / latest_event*\* / last_checked_at，寫 events 與 run log。
