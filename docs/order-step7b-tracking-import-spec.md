...
{
  "rows": [
    { "orderId": 101, "trackingProvider": "711", "trackingCode": "F45913208600" },
    { "orderId": 102, "trackingProvider": "familymart", "trackingCode": "FM123456789" }
  ]
}
```
...
*文件版本：Step 7B Spec v1.0*
*撰寫日期：2026-06-06*
*撰寫：Claude B（Fixed Latest File Mode）*
*現況依據：docs/order-step7-current-field-audit.md（commit 8794d8c）、docs/order-step7-customer-shipment-status-spec.md（commit bd75161）*
*分支：feat/step6d-edit-order-cvs-store-picker*
