...
export const tripRoutesTable = pgTable(
  "trip_routes",
  {
    ...
    etcJpyIsOverridden: boolean("etc_jpy_is_overridden")
      .notNull()
      .default(false),
    fee1_5PctOverride: numeric("fee_1_5pct_override"),
    fee1_5PctIsOverridden: boolean("fee_1_5pct_is_overridden")
      .notNull()
      .default(false),
    totalJpyOverride: numeric("total_jpy_override"),
    totalJpyIsOverridden: boolean("total_jpy_is_overridden")
      .notNull()
      .default(false),
    domesticPerItemOverride: numeric("domestic_per_item_override"),
    domesticPerItemIsOverridden: boolean("domestic_per_item_is_overridden")
      .notNull()
      .default(false),
    transportPerItemOverride: numeric("transport_per_item_override"),
    transportPerItemIsOverridden: boolean("transport_per_item_is_overridden")
      .notNull()
      .default(false),
    finalCostPerItemOverride: numeric("final_cost_per_item_override"),
    finalCostPerItemIsOverridden: boolean("final_cost_per_item_is_overridden")
      .notNull()
      .default(false),
...
export const insertTripRouteSchema = createInsertSchema(tripRoutesTable).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
