...
export const storesTable = pgTable(
  "stores",
  {
    ...
    shippingBlackCatEnabled: boolean("shipping_black_cat_enabled")
      .notNull()
      .default(true),
    shippingPostOfficeEnabled: boolean("shipping_post_office_enabled")
      .notNull()
      .default(true),
    shippingSelfPickupEnabled: boolean("shipping_self_pickup_enabled")
      .notNull()
      .default(true),
