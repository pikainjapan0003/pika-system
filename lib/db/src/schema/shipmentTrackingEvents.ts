...
export type ShipmentTrackingEventStatus =
  (typeof shipmentTrackingEventStatusEnum)[number];
...
export const shipmentTrackingEventsTable = pgTable(
  ...
  (t) => [
    ...
    unique("shipment_tracking_events_tracking_id_idempotency_key_unique").on(
...
export const insertShipmentTrackingEventSchema = createInsertSchema(
  shipmentTrackingEventsTable,
).omit({ id: true, createdAt: true });
export type InsertShipmentTrackingEvent = z.infer<
  typeof insertShipmentTrackingEventSchema
>;
