...
export const productsTable = pgTable("products", {
  ...
  check("products_vip_price_non_negative", sql`${t.vipPrice} IS NULL OR ${t.vipPrice} >= 0`),
  check("products_wholesale_price_non_negative", sql`${t.wholesalePrice} IS NULL OR ${t.wholesalePrice} >= 0`),
  check("products_partner_price_non_negative", sql`${t.partnerPrice} IS NULL OR ${t.partnerPrice} >= 0`),
