...
test("mixed exempt and allocated items capture the approved exact quantity total", () => {
  ...
  // 220 × 2 + 186.359041656250 × 3 = 999.077124968750 (expectation hand-calculated before execution).
  assert.equal(captured.cartProfitSnapshotStatus, "captured");
  assert.equal(captured.cartProfitSnapshotTotalTwd, "999.077124968750");
