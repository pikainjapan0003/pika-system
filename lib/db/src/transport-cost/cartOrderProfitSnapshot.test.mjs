...
test("mixed exempt and allocated items capture the approved exact quantity total", () => {
  ...
  // 220 × 2 + 192.408659336002066... × 3 =
  // 1017.225978008006198... (expectation hand-calculated before execution).
  assert.equal(captured.cartProfitSnapshotStatus, "captured");
  assert.equal(captured.cartProfitSnapshotTotalTwd, "1017.225978008006");
