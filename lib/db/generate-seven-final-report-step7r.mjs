...
async function main() {
  ...
  const DISTRICTS_FILE =
    "/home/runner/workspace/data/cvs/taiwan-city-districts.json";
  ...
  // Write JSON
  const jsonPath =
    "/home/runner/workspace/data/cvs/seven-final-coverage-report-step7r.json";
  ...
  const csvPath =
    "/home/runner/workspace/data/cvs/seven-final-coverage-report-step7r.csv";
